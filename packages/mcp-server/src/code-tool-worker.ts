...
const fuse = new Fuse(
  [
    ...
    'conductor.qbd.salesTaxGroupItems.retrieve',
    'conductor.qbd.salesTaxGroupItems.update',
    ...
    'conductor.qbd.salesTaxPaymentChecks.delete',
    'conductor.qbd.salesTaxPaymentChecks.list',
    'conductor.qbd.salesTaxPaymentChecks.retrieve',
    'conductor.qbd.salesTaxPaymentChecks.update',
    'conductor.qbd.salesTaxPaymentChecks.void',
