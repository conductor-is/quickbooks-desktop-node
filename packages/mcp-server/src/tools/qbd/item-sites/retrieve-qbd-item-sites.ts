...
export const handler = async (client: Conductor, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.qbd.itemSites.retrieve(id, body)));
};
