...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['name', 'paymentMethodType', 'Conductor-End-User-Id'],
  },
  annotations: {},
};
...
export const handler = async (conductor: Conductor, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await conductor.qbd.paymentMethods.create(body)));
  } catch (error) {
