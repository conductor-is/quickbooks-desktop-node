...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['transactionType', 'conductorEndUserId'],
  },
  annotations: {
    readOnlyHint: true,
  },
