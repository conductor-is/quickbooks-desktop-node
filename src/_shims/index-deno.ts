...
export function fileFromPath() {
  throw new Error(
    'The `fileFromPath` function is only supported in Node. See the README for more details: https://www.github.com/conductor-is/quickbooks-desktop-node#file-uploads',
  );
}
